...
namespace CAE___Grandes_Actores___FarmaParafarma
{
    public partial class Data2
    {
        ...
        private void Hoja2_Startup(object sender, System.EventArgs e)
        {
            ...
            try
            {
                oTable = Helppers.importData(oCfg.ConnectionString, "SELECT * FROM " + oJob.SQLParameters.TableName.Replace(@"%identity%", "2"), this);
            }
            catch
            {
                this.oTable = null;
                Globals.ThisWorkbook.StatusMessage = "Error getting data in sheet 2";
