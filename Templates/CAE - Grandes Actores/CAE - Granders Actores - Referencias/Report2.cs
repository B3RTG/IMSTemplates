    ...
    public partial class Report2
    {
                ...
                if (Globals.ThisWorkbook.StatusCorrect)
                {
                    if (this.paint_data())
                    {
                        if (this.format_data() && CAE___Granders_Actores___Referencias.Helppers.SetupHeaders(Globals.Data1, this))
                        {
                            ...
                            //Globals.Data1.Visible = Excel.XlSheetVisibility.xlSheetHidden;
                            Globals.Data1.Delete();
                            if (System.IO.File.Exists(sFileName)) System.IO.File.Delete(sFileName);

                            this.Activate();
                            this.Range["A1"].Activate();

                            Globals.Report1.Activate();
        ...
        public bool paint_data()
        {
            ...
            */
            ...
            //oRangeEnd = oRangeStart.End[Excel.XlDirection.xlDown];
            oRangeColumn = oData1.Range["W2:Y" + iMaxRow.ToString()]; //oData1.Range[oRangeStart, oRangeEnd];
            ...
            */
            ...
            //oRangeEnd = oRangeStart.End[Excel.XlDirection.xlDown];
            oRangeColumn = oData1.Range["Z2:AB" + iMaxRow.ToString()]; //oData1.Range[oRangeStart, oRangeEnd];
            ...
            */
            ...
            //oRangeEnd = oRangeStart.End[Excel.XlDirection.xlDown];
            oRangeColumn = oData1.Range["C2:D" + iMaxRow.ToString()]; //oData1.Range[oRangeStart, oRangeEnd];
            ...
            */
            ...
            //oRangeEnd = oRangeStart.End[Excel.XlDirection.xlDown];
            oRangeColumn = oData1.Range["E2:G" + iMaxRow.ToString()]; //oData1.Range[oRangeStart, oRangeEnd];
            ...
            */
            ...
            //oRangeEnd = oRangeStart.End[Excel.XlDirection.xlDown];
            oRangeColumn = oData1.Range["H2:J" + iMaxRow.ToString()]; //oData1.Range[oRangeStart, oRangeEnd];
            ...
            */
            ...
            //oRangeEnd = oRangeStart.End[Excel.XlDirection.xlDown];
            oRangeColumn = oData1.Range["K2:M" + iMaxRow.ToString()]; //oData1.Range[oRangeStart, oRangeEnd];
            ...
            */
            ...
            //oRangeEnd = oRangeStart.End[Excel.XlDirection.xlDown];
            oRangeColumn = oData1.Range["T2:V" + iMaxRow.ToString()]; //oData1.Range[oRangeStart, oRangeEnd];
            ...
            */
            ...
            //oRangeEnd = oRangeStart.End[Excel.XlDirection.xlDown];
            oRangeColumn = oData1.Range["N2:P" + iMaxRow.ToString()]; //oData1.Range[oRangeStart, oRangeEnd];
            ...
            //oRangeEnd = oRangeStart.End[Excel.XlDirection.xlDown];
            oRangeColumn = oData1.Range["Q2:S" + iMaxRow.ToString()]; //oData1.Range[oRangeStart, oRangeEnd];
