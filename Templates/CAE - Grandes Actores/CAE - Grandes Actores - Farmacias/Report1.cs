...
namespace CAE___Grandes_Actores___Farmacias
{
    ...
    {
        private void Hoja5_Startup(object sender, System.EventArgs e)
        {
            ...
            try
            {
                if (Globals.ThisWorkbook.StatusCorrect)
                {
                    if (this.paint_data())
                    {
                        if (this.format_data() && Helppers.SetupHeaders(Globals.Data1, this))
                        {
        ...
        public bool paint_data()
        {
            ...
            CAE___Grandes_Actores___Farmacias.Data1 oData1 = Globals.Data1;
        ...
        private void Hoja5_Shutdown(object sender, System.EventArgs e)
        {
        }
        ...
        {
            this.Startup += new System.EventHandler(Hoja5_Startup);
            this.Shutdown += new System.EventHandler(Hoja5_Shutdown);
        }
